...
function peg$parse(input, options) {
  ...
  var peg$f5 = function(id, EtiquetaVarios) {
  ...
  var peg$f17 = function(content, isCase) {
    return new n.Clase(content, isCase);
};
  var peg$f18 = function(rangoInicial, rangoFinal) {
